...
//console.log(`issuerAzClientSecret: ${issuerAzClientSecret}`);
const kvCredentials = new ClientSecretCredential(config.azTenantId, config.azClientId, issuerAzClientSecret);
